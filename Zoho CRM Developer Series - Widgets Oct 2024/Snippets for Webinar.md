...
- Download library folder from [here](project_folder_structure_with_library.zip) 
...
- Paste this below #header div within #widget-container div
...
- Paste this below #input-fields div within #widget-container div
```html
<div id="calendar"></div>
```
...
```
- Paste this within initWidget function
```js
...
```
- Paste this as then statement for populateUserList function
```js
...
- Paste this within options map in initCalendar function
```js
events : {
